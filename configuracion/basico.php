    ...
    <body>
        ...
        <main class="contenido">
            ...
            <h3>Pais: <?= $pais? htmlspecialchars($pais['nombre']) : 'No seleccionado' ?></h3>
            <h3>Departamento: <?= $departamento? htmlspecialchars($departamento['nombre']) : 'No seleccionado' ?></h3>
            <h3>Ciudad: <?= $c? htmlspecialchars($c['nombre']) : 'No seleccionada' ?></h3>
            </div>
